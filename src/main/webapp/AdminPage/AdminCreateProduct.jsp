        ...
        <div id="page-content-wrapper" class="w-100">
            <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                <div class="container-fluid">
                    ...
                    <h2 class="ms-auto">Thêm Mới Sản Phẩm</h2>
                </div>
            </nav>
				    ...
				    <div class="row">
				        ...
				        <div class="col-md-6">
				            <div class="custom-file-container">
				                <img src="https://via.placeholder.com/600" alt="Product Preview" id="imagePreview" class="mb-3">
				                <label for="image" class="btn btn-secondary">Chọn ảnh</label>
				                <input type="file" class="form-control d-none" id="image" name="image" accept="image/*" required onchange="previewImage(event)">
				            </div>
				        </div>
				        ...
				        <div class="col-md-6">
				            ...
				            <!-- Trạng thái và Loại hàng trên cùng một hàng -->
				            <div class="mb-3 row">				               
				                <!-- Loại hàng -->
				                <div class="col-md-6">
				            ...
				            <div class="mb-3 row">
				                <div class="col-md-6">
				                    ...
				                    <input type="number" step="0.001" class="form-control" min="1" id="price" name="price" placeholder="Nhập giá sản phẩm" required>
				                </div>
				                <div class="col-md-4">
				                    <label for="stock" class="form-label">Số lượng</label>
				                    <input type="number" class="form-control" id="stock" min="0" name="stock" placeholder="Nhập số lượng" required>
				                </div>
				            </div>
